...
export default function Footer() {
  return (
    <footer className="bg-white border-t-2 border-gray-200 overflow-hidden">
      <div className="mx-5">
        <div className="max-w-screen-lg sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
          ...
          {FOOTER_LINKS.map((linkInfo) => (
            <div className="py-5 border-t-2 border-gray-200 md:border-none">
              <div
              ...
              {linkInfo.links.map((link) => (
                <Link
                  key={link.path}
                  className="my-3 block font-medium text-gray-900 hover:underline duration-100 hover:text-green-500"
                  href={link.path}
                >
                  {link.name}
                </Link>
      ...
      <div className=" pt-2">
        <div className="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
          ...
          <div className="my-5 text-md sm:text-lg">
            © {COPY_RIGHT}
            <span className="text-green-500 font-extrabold"> {GREEN_LINE}</span>
          </div>
        </div>
      </div>
    </footer>
